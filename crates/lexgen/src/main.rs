...
/// Vocabulary packs (ADR 0053): (name, path). An angloform document doesn't
...
fn render_context(entries: &[SeedEntry]) -> String {
    let mut out = String::from(
        "# angloform — Ubiquitous Language\n\n\
         *Generated by lexgen from domain/model.json — do not edit; edit the model.*\n\n\
         Every project term, with its definition in angloform. Noun terms are\n\
