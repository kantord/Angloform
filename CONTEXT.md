...
**English** (name, unique) — English is the language of the corpus. Angloform is a subset of English. a Translation Pair maps a sentence of English to a sentence of Angloform.
...
**Gherkin** (name, unique) — Gherkin is a format for a test. a file of Gherkin describes a feature of a program. every scenario of the file is a Step Block. a file of Gherkin is a document of Angloform, so the Linter lints every file in the folder "features".
  Examples: 
  ```
...
**Language Model** (noun, category) — a Language Model is a program. a Language Model reads a text and writes a text. a Language Model reads a sentence in the order of the words. a Language Model holds a small memory, so a long Open Dependency hurts a Language Model.
  Examples: `a Language Model wrote the decision "0006" in Angloform.`
